...
def driver_fd_SP():
     ...
     yapp1 = make_FDmatDir_SP(x1,h1,N1,alpha,beta)
     yapp2 = make_FDmatDir_SP(x2,h2,N2,alpha,beta)
     yapp3 = make_FDmatDir_SP(x3,h3,N3,alpha,beta)
     yapp4 = make_FDmatDir_SP(x4,h4,N4,alpha,beta)
